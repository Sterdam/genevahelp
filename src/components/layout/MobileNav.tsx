...
export function MobileNav({ view, onViewChange }: MobileNavProps) {
  ...
  const NavItem = ({
    ...
    const className = `flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-lg transition-colors ${
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-gray-200 z-30 sm:hidden safe-area-bottom">
